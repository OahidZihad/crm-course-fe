...
export default function StudentBlogPostPage({ params }: PageProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        {isOwner && (
          <div className="flex gap-2">
            <Link href={`/student/blog/${postId}/edit`}>
              <Button
                variant="outline"
                className="font-bold border-2 border-border shadow-[4px_4px_0px_0px_#a8a6ff]"
              >
      ...
      {post.status !== "approved" && (
        ...
        >
          {post.status === "draft" && (
            <p>
              📝 This is a draft. Submit it for review when you're ready to
              publish.
            </p>
          )}
          {post.status === "pending" && (
            <p>
              ⏳ This post is pending review. You'll be notified once it's
              approved.
            </p>
          )}
